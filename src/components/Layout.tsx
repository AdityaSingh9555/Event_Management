  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div 
        ...
        style={{
          backgroundImage: `
            radial-gradient(circle at 0% 0%, rgba(168, 85, 247, 0.6) 0%, transparent 40%),
            radial-gradient(circle at 100% 0%, rgba(99, 102, 241, 0.6) 0%, transparent 40%),
            radial-gradient(circle at 100% 100%, rgba(168, 85, 247, 0.6) 0%, transparent 40%),
            radial-gradient(circle at 0% 100%, rgba(99, 102, 241, 0.6) 0%, transparent 40%)
          `
        }} 
      />
    </div>
